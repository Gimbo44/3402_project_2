 ...
 */
  ...
  if(taskid != MASTER) {
    if(taskid+1 == numtasks){
      ...
      prsys(local_adiag, local_aleft, local_arite, local_f, nu,offset_nu,nu);
    }else{
      ...
      prsys(local_adiag, local_aleft, local_arite, local_f, nu,offset_nu,chunksize_nu+offset_nu);
    ...
    prsys(local_adiag, local_aleft, local_arite, local_f, nu,offset_nu,chunksize_nu);
  }
